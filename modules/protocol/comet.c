 ...
 *
 * This file contains protocol support for comet.
 */

#include <atheme.h>
#include <atheme/protocol/comet.h>
...
static const struct cmode comet_mode_list[] = {
  { 'i', CMODE_INVITE },
  { 'm', CMODE_MOD    },
  { 'n', CMODE_NOEXT  },
  { 'p', CMODE_PRIV   },
...
static const struct cmode comet_user_mode_list[] = {
  { 'p', UF_IMMUNE   },
  { 'a', UF_ADMIN    },
  { 'i', UF_INVIS    },
  { 'o', UF_IRCOP    },
...
static bool
comet_is_valid_hostslash(const char *host)
{
	const char *p;
	bool dot = false;
...
static void
comet_wallops_sts(const char *reason)
{
...
static void
comet_on_login(struct user *u, struct myuser *mu, const char *wantedhost)
{
...
static bool
comet_on_logout(struct user *u, const char *account)
{
...
mod_init(struct module *const restrict m)
{
	...
	mode_list = comet_mode_list;
	user_mode_list = comet_user_mode_list;

	wallops_sts = &comet_wallops_sts;
	ircd_on_login = &comet_on_login;
	ircd_on_logout = &comet_on_logout;
	is_valid_host = &comet_is_valid_hostslash;
	is_ircop = &comet_is_ircop;
...
SIMPLE_DECLARE_MODULE_V1("protocol/comet", MODULE_UNLOAD_CAPABILITY_NEVER)
